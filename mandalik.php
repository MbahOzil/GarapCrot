...
echo "\n";
echo "\n";
echo "REGISTER ALFAGIFT CROTTTT....!! \n";
echo "--------------------------- \n";
...
$data_create = '{"address":"","birthDate":"1991-10-11","debug":false,"deviceId":'.$deviceid2.',"email":'.$random_email.',"firstName":"","fullName":'.$random_name.',"gender":"F","lastName":"","latitude":0,"longitude":0,"maritalStatus":"M","password":"Bijikodok11","phone":'.$nomorhp.',"postCode":"","registerPonta":true,"token":'.$token2.'}';
...
if($status_create !== "00"){
    ...
    echo "| Sukses daftar!!! \n";
    echo "| Nomer hp $no_hp dan password Bijikodok11 \n";
